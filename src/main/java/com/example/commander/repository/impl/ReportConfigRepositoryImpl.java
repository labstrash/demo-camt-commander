...
/**
 * JDBC implementation of {@link ReportConfigRepository}.
 *
 * <p>Performs single-row lookups for recipients and report configurations
 * used in on-demand report generation.
 *
 * <p>See the class-level note on {@link ReportConfigRepository}:
 * {@code findActiveByRecipientAndReportType} backs the on-demand trigger path;
