...
import com.example.commander.adapter.persistence.tvp.TvpParameterSource;
...
/**
 * JDBC implementation of {@link ReportConfigTreeRepository}.
 *
...
public class ReportConfigTreeRepositoryImpl implements ReportConfigTreeRepository {
    ...
    private final ReportConfigReadProperties properties;
