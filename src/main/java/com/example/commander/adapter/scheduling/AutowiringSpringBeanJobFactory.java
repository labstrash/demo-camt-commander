 ...
 * dependency injection entirely. For job classes registered as Spring beans (e.g. via {@code
 * @Component}), this factory fetches the instance from the {@link ApplicationContext} so
 * constructor injection works as it does for any other Spring bean. Job classes that are
