 ...
 *
 * <p>Kept separate from the application's primary DataSource (spring.datasource.*) so Quartz's
 * clustered lock-acquisition/check-in polling can never starve, or be starved by, connections
 * used for application-level work. Spring Boot's Quartz autoconfiguration picks up whichever
 * DataSource bean is qualified with {@link QuartzDataSource} in place of the primary one.
 */
@Configuration
