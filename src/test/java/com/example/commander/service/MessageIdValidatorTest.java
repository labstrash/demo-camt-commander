...
class MessageIdValidatorTest {
    ...
    void acceptsAMessageIdUnderTheLengthCeiling() {
        ...
        assertThatCode(() -> validator.validate(id34Chars, 1, "CAMT054C")).doesNotThrowAnyException();
    }
    ...
    void acceptsAMessageIdExactlyAtTheLengthCeiling() {
        ...
        assertThatCode(() -> validator.validate(id35Chars, 1, "CAMT054C")).doesNotThrowAnyException();
    }
    ...
    void rejectsAMessageIdOneOverTheLengthCeiling() {
        ...
        assertThatThrownBy(() -> validator.validate(id36Chars, 1, "CAMT054C"))
    ...
    void rejectsANullMessageId() {
        assertThatThrownBy(() -> validator.validate(null, 1, "CAMT054C"))
                .isInstanceOf(IllegalStateException.class)
