...
import com.example.commander.domain.assembly.AllocationMapper;
import com.example.commander.domain.assembly.BundledGroupingStrategy;
import com.example.commander.domain.assembly.CorrelationIdGenerator;
import com.example.commander.domain.assembly.MessageGroupingStrategyFactory;
import com.example.commander.domain.assembly.MessageIdValidator;
import com.example.commander.domain.assembly.OutboundMessageBuilder;
import com.example.commander.domain.assembly.PaymentTypeGrouper;
import com.example.commander.domain.assembly.ReportMessageAssembler;
import com.example.commander.domain.assembly.ReportMessageIdGenerator;
import com.example.commander.domain.assembly.UnbundledGroupingStrategy;
 ...
 *
 * <p>{@link ReportMessageAssembler} is real (pure Java, no DB dependency); only the
...
class ReportPipelineItemReaderTest {
    ...
    @Mock
    private ReportConfigTreeRepository repository;
