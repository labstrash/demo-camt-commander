...
/**
 * Unit tests for {@link ReportCommandAuditRepositoryImpl}, mocking {@link JdbcTemplate} — same
 * pattern as {@code DeadLetterMessageRepositoryImplTest}, no real database needed.
 */
@ExtendWith(MockitoExtension.class)
class ReportCommandAuditRepositoryImplTest {
    ...
    private ReportCommandAuditRepositoryImpl repository;
