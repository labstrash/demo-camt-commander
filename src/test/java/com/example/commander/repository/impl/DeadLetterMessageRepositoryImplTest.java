...
/**
 * Unit tests for {@link DeadLetterMessageRepositoryImpl}, mocking {@link JdbcTemplate} the
 * same way {@code ReportConfigRepositoryImplTest} does — no real database needed.
 *
 ...
 * Object...} varargs form — see the class javadoc on {@link DeadLetterMessageRepositoryImpl}
...
class DeadLetterMessageRepositoryImplTest {
    ...
    private DeadLetterMessageRepositoryImpl repository;

    @BeforeEach
    void setUp() {
        repository = new DeadLetterMessageRepositoryImpl(jdbcTemplate);
    }
    ...
    void findDueForRetryReturnsWhatTheQueryMaps() {
        ...
        List<DeadLetterMessage> result = repository.findDueForRetry(50);
